...
def ai_project_view(ai_project_id):
    ...
    if username:
        ...
        cerebrium_configs = user_data.get('cerebrium_configs', [])
    ...
    api_examples = []
    api_base_url = f"{server_domain}/api/v1"
...
'''
    ...
    return render_template(
        ...
        cerebrium_configs=cerebrium_configs,
        space_card_type=space_card_type,
        s3_public_base_url=s3_public_base_url,
        current_username=username,
        last_cerebrium_result=last_cerebrium_result,
        cerebrium_timeout_seconds=cerebrium_timeout_seconds
    )
